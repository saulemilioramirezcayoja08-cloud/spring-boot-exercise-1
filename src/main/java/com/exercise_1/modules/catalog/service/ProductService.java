...
public class ProductService {
    ...
    public ProductPageResponseDto getAllProducts(Pageable pageable) {
        try {
            ...
            return buildPageResponse(productPage, "Products retrieved successfully");
        } catch (Exception e) {
    ...
    @Transactional(readOnly = true)
    public ProductPageResponseDto searchByName(String name, Pageable pageable) {
        try {
            Page<Product> productPage = productRepository.findByNameContainingIgnoreCasePageable(name, pageable);
            return buildPageResponse(productPage, "Products search completed successfully");
        } catch (Exception e) {
            return ProductPageResponseDto.builder()
                    .success(false)
                    .message("Error searching products: " + e.getMessage())
    ...
    private ProductPageResponseDto buildPageResponse(Page<Product> productPage, String message) {
        List<ProductPageResponseDto.ProductListItem> content = productPage.getContent().stream()
                .map(product -> ProductPageResponseDto.ProductListItem.builder()
                        .id(product.getId())
                        .sku(product.getSku())
                        .name(product.getName())
        ...
        ProductPageResponseDto.PaginationInfo pagination = ProductPageResponseDto.PaginationInfo.builder()
        ...
        ProductPageResponseDto.PageData pageData = ProductPageResponseDto.PageData.builder()
                .content(content)
